                      ...
                      children: [
                        Container(
                          ...
                          child:Column(
                            ...
                            children: [
                              Expanded(child:Text("Recuperar contraseña", style: TextStyle(fontSize: isTablet?responsive.fontSizeSubT:responsive.dp(3.3),color: Colors.white,fontFamily: "Poppins",fontWeight: FontWeight.bold)),),
                              Expanded(child:Text("Se enviará un codigo de verificación a tu correo", style: TextStyle(fontSize: responsive.fontSizeNormal,color: Colors.white,fontFamily: "Poppins",),)),
                            ],
                          ),
                        ),
                        correo,
