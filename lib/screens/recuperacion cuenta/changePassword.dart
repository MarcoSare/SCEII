              ...
              children: <Widget>[
                ...
                Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text("Recuperar contraseña",textAlign: TextAlign.center, style: TextStyle(fontSize: responsive.fontSizeSubT,color: Colors.white,fontFamily: "Poppins",fontWeight: FontWeight.bold)),
                        Text("Se envió el codigo a " + widget.correo, textAlign: TextAlign.center,style: TextStyle(fontSize: responsive.fontSizeNormal,color: Colors.white,fontFamily: "Poppins")),
                        if(!isAcept)
                        Text("¿No has recibido el código?", style: TextStyle(fontSize: responsive.fontSizeNormal,color: Colors.white,fontFamily: "Poppins")),
                        if(isAcept)
                        Text("Escriba su nueva contraseña", style: TextStyle(fontSize: responsive.fontSizeNormal,color: Colors.white,fontFamily: "Poppins")),
                        if(!isAcept)
                        TextButton(onPressed:(){
                        }, child:Text("Solicita un nuevo código", style: TextStyle(fontSize: responsive.fontSizeNormal,color:Color.fromRGBO(70, 165, 37, 1) ,fontFamily: "Poppins",),),
                        ),
                        ...
                        Text("El código no corresponde",
                            style: TextStyle(fontSize: responsive.fontSizeNormal,color: Colors.red,fontFamily: "Poppins")),
                        Container(
